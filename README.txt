...
{"l_addr": "0.0.0.0", "l_port": "50100", "sdc_url": "http://<fqdn>:<port>/api/v1/sbo", "salty_url": "https://www.saltybet.com/state.json"}
...
sudo docker run --name sbo -p 50100:50100 --mount source=sbo_data,target=/SBO/app/mnt sbo
